<Prompt description="Create a rent-free associated token account with Anchor macros" actions={["copy", "cursor"]}>
{`---
description: Create a rent-free associated token account with Anchor macros
allowed-tools: Bash, Read, Write, Edit, Glob, Grep, WebFetch, AskUserQuestion, Task, TaskCreate, TaskGet, TaskList, TaskUpdate, TaskOutput, mcp__deepwiki, mcp__zkcompression
---

## Create a rent-free associated token account with Anchor macros
...
- Identify: existing program module, account structs, associated token account patterns
...
### 3. Clarify intention
- AskUserQuestion: what is the goal? (new program from scratch, add rent-free associated token account to existing program, migrate from SPL create_associated_token_account)
