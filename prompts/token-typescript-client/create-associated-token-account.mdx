...
- Identify: RPC setup, existing associated token account logic, entry point for associated token account creation
...
- AskUserQuestion: does the project already have associated token account operations to extend, or is this greenfield?
